    ...
    <div className="bg-card rounded-2xl card-shadow p-4 transition-all duration-300 hover:card-shadow-hover animate-fade-in relative">
      ...
      <div className="flex gap-3">
        ...
        <div className="flex-1 min-w-0">
          ...
          <p className="text-xs text-muted-foreground mb-2">{provider.category}</p>
          ...
          <div className="flex gap-2">
            ...
            <button className="flex-1 py-2 rounded-xl bg-secondary text-xs font-semibold text-secondary-foreground active:scale-[0.98] transition-transform flex items-center justify-center gap-1">
