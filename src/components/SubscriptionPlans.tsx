...
const landlordPlans = [
  {
    ...
    price: 500,
    duration: "/month",
    features: ["3 active listings", "Residential rentals only", "Basic analytics", "Guest inquiries", "Standard placement"],
    notIncluded: ["Commercial premises", "Corporate stays", "Boost listings", "County heatmaps"],
    current: false,
  },
  {
    name: "Pro",
    price: 1000,
    duration: "/month",
    features: ["10 active listings", "Residential rentals only", "Full analytics", "Priority chat", "1 monthly boost", "Lead tracking"],
    notIncluded: ["Commercial premises", "Corporate stays", "County heatmaps"],
    popular: true,
    current: false,
  },
  {
    ...
    price: 2000,
    duration: "/month",
    features: ["Unlimited listings", "✨ Commercial premises (shops/offices)", "✨ Corporate stays (NGO/expat)", "Full analytics", "3 monthly boosts", "Featured badge", "County heatmaps", "Priority support"],
    notIncluded: [],
    current: false,
  },
];
...
const agencyPlans = [
  {
    ...
    price: 2000,
    duration: "/month",
    features: ["5 agent accounts", "50 listings", "Residential rentals only", "Basic CRM", "Lead assignment"],
    notIncluded: ["Commercial premises", "Corporate stays", "API access", "White label"],
    current: false,
  },
  {
    name: "Growth",
    price: 5000,
    duration: "/month",
    features: ["15 agent accounts", "200 listings", "Residential rentals only", "Full CRM", "Performance analytics", "5 monthly boosts"],
    notIncluded: ["Commercial premises", "Corporate stays", "API access", "White label"],
    popular: true,
    current: false,
  },
  {
    ...
    price: 10000,
    duration: "/month",
    features: ["Unlimited agents", "Unlimited listings", "✨ Commercial premises (shops/offices)", "✨ Corporate stays (NGO/expat)", "Full CRM", "Priority support", "API access", "Custom branding"],
    notIncluded: [],
    current: false,
  },
];
