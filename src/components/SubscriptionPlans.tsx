...
const agencyPlans = [
  ...
  },
  {
    ...
    notIncluded: ["Corporate stays", "API access", "White label"],
    popular: true,
    current: false,
  },
  {
    ...
    duration: "/month",
    badge: "Agency",
    features: ["Unlimited agents", "Unlimited listings", "✨ Commercial premises", "✨ Corporate stays (NGO/expat)", "Full CRM + lead routing", "API access & integrations", "White-label custom branding", "Dedicated account manager", "Priority support 24/7"],
    notIncluded: [],
    current: false,
  },
];
