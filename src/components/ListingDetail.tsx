  ...
  return (
    <div className="fixed inset-0 z-40 bg-background overflow-y-auto animate-slide-up">
      ...
      <div className="px-4 py-5 pb-32">
        ...
        {property.verified && (
          <div className="p-4 rounded-2xl bg-primary/5 border border-primary/15 mb-4">
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1">
                ...
                <p className="text-[10px] text-muted-foreground">All listing photos passed authenticity & originality checks</p>
              </div>
