...
export interface ServiceProvider {
  ...
  portfolio?: { title: string; photos: string[]; beforeAfter?: { before: string; after: string } }[];
}
...
export const serviceProviders: ServiceProvider[] = [
  { id: "s1", name: "SwiftMovers KE", category: "Movers", rating: 4.8, reviews: 234, responseSpeed: "< 5 mins", areaServed: "Nairobi & Environs", tier: "Premium", boosted: true, avatar: "🚛", description: "Professional moving services across Nairobi", price: "From KES 5,000", availability: "Same day", lat: -1.2780, lng: 36.8150, recentReviews: [{ author: "Anne M.", rating: 5, text: "Moved my 3BR in under 4 hours. Very careful with fragile items!", date: "2 days ago" }, { author: "Brian K.", rating: 4, text: "Good team, showed up on time. Minor scratch on one table.", date: "1 week ago" }], portfolio: [{ title: "Full House Move", photos: ["https://images.unsplash.com/photo-1600585154340-be6161a56a0c?w=400&h=300&fit=crop", "https://images.unsplash.com/photo-1600596542815-ffad4c1539a9?w=400&h=300&fit=crop", "https://images.unsplash.com/photo-1600607687939-ce8a6c25118c?w=400&h=300&fit=crop"] }, { title: "Office Relocation", photos: ["https://images.unsplash.com/photo-1600566753376-12c8ab7c3376?w=400&h=300&fit=crop"] }] },
  { id: "s2", name: "CleanPro Solutions", category: "Cleaners", rating: 4.6, reviews: 189, responseSpeed: "< 15 mins", areaServed: "Nairobi", tier: "Pro", boosted: false, avatar: "🧹", description: "Deep cleaning and regular housekeeping", price: "From KES 2,500", availability: "Next day", lat: -1.2900, lng: 36.7900, recentReviews: [{ author: "Lucy W.", rating: 5, text: "My apartment has never been this clean! Amazing deep clean.", date: "3 days ago" }, { author: "James O.", rating: 4, text: "Good service, forgot to clean behind the fridge though.", date: "5 days ago" }] },
  { id: "s3", name: "PowerFix Electricals", category: "Electricians", rating: 4.9, reviews: 312, responseSpeed: "< 10 mins", areaServed: "Nairobi, Kiambu", tier: "Premium", boosted: true, avatar: "⚡", description: "Licensed electricians for all installations", price: "From KES 1,500", availability: "Same day", lat: -1.2700, lng: 36.8200, recentReviews: [{ author: "David N.", rating: 5, text: "Fixed a tricky wiring issue in 30 mins. Very knowledgeable!", date: "1 day ago" }, { author: "Grace K.", rating: 5, text: "Installed my cooker connection perfectly. Fair pricing.", date: "4 days ago" }], portfolio: [{ title: "Office Wiring", photos: ["https://images.unsplash.com/photo-1621905252507-b35492cc74b4?w=400&h=300&fit=crop", "https://images.unsplash.com/photo-1558618666-fcd25c85f82e?w=400&h=300&fit=crop"], beforeAfter: { before: "https://images.unsplash.com/photo-1621905252507-b35492cc74b4?w=400&h=300&fit=crop", after: "https://images.unsplash.com/photo-1558618666-fcd25c85f82e?w=400&h=300&fit=crop" } }] },
  { id: "s4", name: "PipeMaster Plumbing", category: "Plumbers", rating: 4.5, reviews: 156, responseSpeed: "< 20 mins", areaServed: "Nairobi", tier: "Pro", boosted: false, avatar: "🔧", description: "Emergency and scheduled plumbing services", price: "From KES 1,000", availability: "2 hours", lat: -1.3050, lng: 36.8300, recentReviews: [{ author: "Peter M.", rating: 5, text: "Came within 30 mins for an emergency leak. Lifesaver!", date: "2 days ago" }, { author: "Sarah J.", rating: 4, text: "Fixed the kitchen sink. Could have cleaned up a bit more after.", date: "1 week ago" }] },
  { id: "s5", name: "NetConnect KE", category: "Internet Installers", rating: 4.7, reviews: 278, responseSpeed: "< 30 mins", areaServed: "Nairobi, Mombasa", tier: "Premium", boosted: false, avatar: "📡", description: "Fiber and WiFi installation specialists", price: "From KES 3,000", availability: "Next day", lat: -1.2600, lng: 36.8050, recentReviews: [{ author: "Mike T.", rating: 5, text: "Fast fiber setup, explained everything clearly. Great speeds!", date: "3 days ago" }] },
  { id: "s6", name: "GuardPro Security", category: "Security", rating: 4.8, reviews: 198, responseSpeed: "< 10 mins", areaServed: "Nationwide", tier: "Basic", boosted: false, avatar: "🛡️", description: "CCTV, alarms, and guard services", price: "From KES 8,000/mo", availability: "48 hours", lat: -1.2950, lng: 36.7800, recentReviews: [{ author: "Tom W.", rating: 5, text: "Installed 4 CCTV cameras with phone access. Very professional!", date: "1 week ago" }] },
  { id: "s7", name: "BrushMasters Painters", category: "Painters", rating: 4.7, reviews: 145, responseSpeed: "< 30 mins", areaServed: "Nairobi", tier: "Pro", boosted: true, avatar: "🎨", description: "Interior and exterior painting, wallpaper installation", price: "From KES 3,000", availability: "Next day", lat: -1.2850, lng: 36.7950, recentReviews: [{ author: "Carol A.", rating: 5, text: "Beautiful finish on my living room. Color matching was perfect!", date: "4 days ago" }, { author: "Ken R.", rating: 4, text: "Good painters, took a bit longer than estimated but quality work.", date: "2 weeks ago" }], portfolio: [{ title: "Living Room Repaint", photos: ["https://images.unsplash.com/photo-1556909114-f6e7ad7d3136?w=400&h=300&fit=crop", "https://images.unsplash.com/photo-1484154218962-a197022b5858?w=400&h=300&fit=crop"], beforeAfter: { before: "https://images.unsplash.com/photo-1556909114-f6e7ad7d3136?w=400&h=300&fit=crop", after: "https://images.unsplash.com/photo-1484154218962-a197022b5858?w=400&h=300&fit=crop" } }, { title: "Exterior Painting", photos: ["https://images.unsplash.com/photo-1556909172-54557c7e4fb7?w=400&h=300&fit=crop"] }] },
  { id: "s8", name: "PestAway Fumigation", category: "Fumigators", rating: 4.6, reviews: 203, responseSpeed: "< 1 hour", areaServed: "Nairobi, Kiambu", tier: "Premium", boosted: false, avatar: "🪲", description: "Termite, cockroach, and bedbugs fumigation specialists", price: "From KES 2,000", availability: "Same day", lat: -1.2980, lng: 36.8100, recentReviews: [{ author: "Alice N.", rating: 5, text: "No more cockroaches! They were thorough and explained the process.", date: "3 days ago" }, { author: "John P.", rating: 4, text: "Effective treatment. The smell cleared after a day.", date: "1 week ago" }] },
  { id: "s9", name: "WoodCraft Carpenters", category: "Carpenters", rating: 4.8, reviews: 167, responseSpeed: "< 20 mins", areaServed: "Nairobi", tier: "Pro", boosted: true, avatar: "🪚", description: "Custom furniture, cabinets, and woodwork repairs", price: "From KES 2,500", availability: "Next day", lat: -1.2750, lng: 36.8250, recentReviews: [{ author: "Faith M.", rating: 5, text: "Built custom kitchen cabinets. Exceeded expectations!", date: "5 days ago" }, { author: "Dennis O.", rating: 5, text: "Repaired my wardrobe doors. Very skilled and affordable.", date: "1 week ago" }] },
  { id: "s10", name: "GreenScape Gardens", category: "Gardeners", rating: 4.5, reviews: 98, responseSpeed: "< 45 mins", areaServed: "Nairobi", tier: "Basic", boosted: false, avatar: "🌿", description: "Landscaping, lawn care, and garden maintenance", price: "From KES 1,500", availability: "Next day", lat: -1.3000, lng: 36.7850, recentReviews: [{ author: "Rose K.", rating: 4, text: "Nice garden cleanup. Will book again for monthly maintenance.", date: "6 days ago" }] },
  { id: "s11", name: "CoolBreeze AC Services", category: "AC Repair", rating: 4.9, reviews: 221, responseSpeed: "< 15 mins", areaServed: "Nairobi, Mombasa", tier: "Premium", boosted: true, avatar: "❄️", description: "AC installation, servicing, and gas refill", price: "From KES 3,500", availability: "Same day", lat: -1.2680, lng: 36.8180, recentReviews: [{ author: "Edwin L.", rating: 5, text: "AC is blowing cold again! Quick diagnosis and repair.", date: "2 days ago" }, { author: "Mercy W.", rating: 5, text: "Installed a split unit in my bedroom. Clean work!", date: "1 week ago" }] },
  { id: "s12", name: "KeyMaster Locksmiths", category: "Locksmiths", rating: 4.4, reviews: 132, responseSpeed: "< 10 mins", areaServed: "Nairobi", tier: "Pro", boosted: false, avatar: "🔑", description: "Emergency lockouts, key cutting, and lock upgrades", price: "From KES 800", availability: "30 mins", lat: -1.2920, lng: 36.8020, recentReviews: [{ author: "Simon M.", rating: 5, text: "Locked out at midnight, came in 15 mins! Lifesaver.", date: "3 days ago" }] },
  { id: "s13", name: "SteelWorks Welding", category: "Welders", rating: 4.6, reviews: 89, responseSpeed: "< 1 hour", areaServed: "Nairobi, Kiambu", tier: "Basic", boosted: false, avatar: "🔥", description: "Gates, grills, window guards, and metal fabrication", price: "From KES 2,000", availability: "Same day", lat: -1.3100, lng: 36.8300, recentReviews: [{ author: "Paul N.", rating: 4, text: "Strong window grills. Took measurements accurately.", date: "1 week ago" }] },
  { id: "s14", name: "BuildRight Masons", category: "Masons", rating: 4.7, reviews: 176, responseSpeed: "< 30 mins", areaServed: "Nairobi & Environs", tier: "Pro", boosted: true, avatar: "🧱", description: "Construction, tiling, plastering, and renovations", price: "From KES 3,000", availability: "Next day", lat: -1.2800, lng: 36.7900, recentReviews: [{ author: "Janet K.", rating: 5, text: "Tiled my entire bathroom beautifully. Very neat work.", date: "4 days ago" }, { author: "George O.", rating: 4, text: "Good plastering job on my wall repairs. Reasonable price.", date: "2 weeks ago" }] },
];
